...
def generar_lista(numero_frecuencia, numero_total):
    # Calcular el valor base y el resto
    valor_base = numero_total // numero_frecuencia
    resto = numero_total % numero_frecuencia

    # Crear la lista con los valores base
    lista = [numero_frecuencia] * valor_base

    # Si hay un resto, ajustar el último valor
    if resto > 0:
        lista.append(resto)
