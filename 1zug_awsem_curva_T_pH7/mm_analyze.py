...
def analyze(args):
    ...
    # apply forces
    forceGroupTable = {"Backbone":20, "Rama":21, "amhgo":22, "Fragment":23, "Membrane":24, "ER":25, "TBM_Q":26, "Beta":27, "Pap":28, "Helical":29,
                        "Q":1, "Rg":2, "Qc":3,
    ...
    showEnergy = ["Backbone", "Rama", "amhgo", "Fragment", "Membrane", "ER", "TBM_Q", "Beta", "Pap", "Helical", "Debye_huckel","Total"]
